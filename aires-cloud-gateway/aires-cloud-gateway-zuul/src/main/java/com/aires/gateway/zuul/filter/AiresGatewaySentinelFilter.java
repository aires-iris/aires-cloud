...
import com.aires.gateway.zuul.fallback.AiresGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class AiresGatewaySentinelFilter {
    @Bean
    ...
    @PostConstruct
    public void doInit() {
        // 注册我们自定义的限流异常处理器AiresGatewayBlockFallbackProvider
        ZuulBlockFallbackManager.registerProvider(new AiresGatewayBlockFallbackProvider());
        initGatewayRules();
    }
