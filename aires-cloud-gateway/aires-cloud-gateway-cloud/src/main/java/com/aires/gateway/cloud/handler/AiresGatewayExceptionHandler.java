package com.aires.gateway.cloud.handler;
 ...
 * @create: 2020-10-17 19:39
 */
@Slf4j
public class AiresGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {
    public AiresGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
