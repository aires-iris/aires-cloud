...
import com.aires.cloud.auth.properties.ValidateCodeProperties;
...
public class ValidateCodeService {
    ...
    public void create(HttpServletRequest request, HttpServletResponse response) throws IOException, ValidateCodeException {
        ...
        redisService.set(AiresConstant.CODE_PREFIX + key, StringUtils.lowerCase(captcha.text()), code.getTime());
    ...
    public void check(String key, String value) throws ValidateCodeException {
        Object codeInRedis = redisService.get(AiresConstant.CODE_PREFIX + key);
    ...
    private Captcha createCaptcha(ValidateCodeProperties code) {
        ...
        if (StringUtils.equalsIgnoreCase(code.getType(), AiresConstant.GIF)) {
    ...
    private void setHeader(HttpServletResponse response, String type) {
        if (StringUtils.equalsIgnoreCase(type, AiresConstant.GIF)) {
